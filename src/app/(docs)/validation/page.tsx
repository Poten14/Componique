  ...
  return (
    <div className="prose max-w-[850px] p-5 text-[#6D6D6D] dark:text-[#bdbdbd]">
      ...
      <div>
        ...
        <CodeBox
          code={`import ValidationEmail from '@components/Validation/ValidationEmail';`}
          copyText={`import ValidationEmail from '@components/Validation/ValidationEmail';`}
          language="tsx"
          index={1}
          copied={copied}
...
export default ValidationEmail;`}
      ...
      <div>
        ...
        <CodeBox
          code={`import ValidationID from '@components/Validation/ValidationID';`}
          copyText={`import ValidationID from '@components/Validation/ValidationID';`}
          language="tsx"
          index={5}
          copied={copied}
          handleCopy={handleCopy}
...
export default Example;`}
        ...
        <CodeBox
          code={`const validateID = (ID: string) => {
...
export default ValidationID;`}
      ...
      <div>
        ...
        <CodeBox
          code={`import ValidationPW from '@components/Validation/ValidationPW';`}
          copyText={`import ValidationPW from '@components/Validation/ValidationPW';`}
          language="tsx"
          index={9}
          copied={copied}
          handleCopy={handleCopy}
...
export default Example;`}
        ...
        <CodeBox
          code={`const validatePW = (PW: string) => {
...
export default ValidationPW;`}
      ...
      <div>
        ...
        <CodeBox
          code={`import ValidationPWConfirm from '@components/Validation/ValidationPWConfirm';`}
...
export default Example;`}
        ...
        <CodeBox
          code={`const validatePWConfirm = (pw: string, confirmPW: string) => {
...
export default ValidationPWConfirm;`}
      ...
      <div>
        ...
        <CodeBox
          code={`import ValidationPhone from '@components/Validation/ValidationPhone';`}
          copyText={`import ValidationPhone from '@components/Validation/ValidationPhone';`}
          language="tsx"
          index={17}
          copied={copied}
          handleCopy={handleCopy}
...
export default Example;`}
        ...
        <CodeBox
          code={`const validatePhone = (phone: string) => {
