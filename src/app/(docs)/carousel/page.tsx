...
const CarouselDocs: React.FC = () => {
  ...
  return (
    <div className="prose max-w-[1000px] p-5 text-[#6D6D6D]">
      <h1 className="text-[#2D3748]">Carousel</h1>
      <p>
      ...
      <CodeBox
        code={`import Carousel from '@components/Carousel';`}
        copyText={`import Carousel from '@components/Carousel';`}
        language="tsx"
        index={1}
        copied={copied}
...
export default Example;`}
      ...
      <h2 className="text-[#2D3748]">Customization</h2>
      <p>
...
export default Example;`}
      ...
      <br />
      <br />
      <h1 className="text-[#2D3748]">CarouselAutoplay</h1>
      <p>
      ...
      <h2 className="text-[#2D3748]">Import</h2>
      <CodeBox
        code={`import CarouselAutoplay from '@components/CarouselAutoplay';`}
        copyText={`import CarouselAutoplay from '@components/CarouselAutoplay';`}
        language="tsx"
        index={1}
        copied={copied}
        handleCopy={handleCopy}
...
export default Example;`}
      ...
      <br />
      <br />
      <h1 className="text-[#2D3748]">CarouselDots</h1>
      <p>
      ...
      <h2 className="text-[#2D3748]">Import</h2>
      <CodeBox
        code={`import CarouselDots from '@components/CarouselDots';`}
        copyText={`import CarouselDots from '@components/CarouselDots';`}
        language="tsx"
        index={1}
        copied={copied}
        handleCopy={handleCopy}
