  ...
  return (
    <div className="prose max-w-[850px] p-5 text-[#6D6D6D]">
      ...
      <CodeBox
        ...
        copyText={`import BreadCrumb from '@components/BreadCrumb/BreadCrumb';`}
        language="tsx"
        index={1}
        copied={copied}
...
export default Example;`}
      ...
      <CodeBox
        code={`import BreadCrumbSlash from '@components/BreadCrumb/BreadCrumbSlash';`}
        copyText={`import BreadCrumbSlash from '@components/BreadCrumb/BreadCrumbSlash';`}
        language="tsx"
        index={1}
        copied={copied}
        handleCopy={handleCopy}
...
export default Example;`}
      ...
      <CodeBox
        code={`import BreadCrumbDropdown from '@components/BreadCrumb/BreadCrumbDropdown';`}
        copyText={`import BreadCrumbDropdown from '@components/BreadCrumb/BreadCrumbDropdown';`}
        language="tsx"
        index={1}
        copied={copied}
        handleCopy={handleCopy}
