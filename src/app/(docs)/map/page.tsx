...
const DynamicMapPosition = dynamic(
  () => import("../../../components/Map/MapPosition"),
  {
    ssr: false,
    loading: () => <p>지도를 불러오는 중...</p>,
  },
...
const MapComponentsDocs: React.FC = () => {
  ...
  return (
    <div className="prose max-w-[850px] p-5 text-[#6D6D6D] dark:text-[#bdbdbd]">
      ...
      <CodeBox
        code={`import DynamicMap from './DynamicMap';`}
        copyText={`import DynamicMap from './DynamicMap';`}
        language="tsx"
        index={0}
        copied={copied}
...
export default MapBasic;`}
        copyText={`import React from "react";
import { MapContainer, TileLayer, Marker, Popup } from "react-leaflet";
import { FaMapMarkerAlt } from "react-icons/fa";
import { renderToString } from "react-dom/server";
import "leaflet/dist/leaflet.css";
...
export default MapBasic;`}
      ...
      <CodeBox
        code={`import DynamicMapPosition from './DynamicMapPosition';`}
        copyText={`import DynamicMapPosition from './DynamicMapPosition';`}
        language="tsx"
        index={3}
        copied={copied}
        handleCopy={handleCopy}
