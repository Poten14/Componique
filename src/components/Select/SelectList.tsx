...
const SelectList = ({ option, onSelect }: SelectListProps) => {
  ...
  return (
    <>
      <div className="w-96">
        <ul className="flex cursor-pointer justify-evenly divide-x divide-gray rounded-lg border border-gray p-0 text-center dark:divide-[#2A6490] dark:border-[#2A6490]">
          {option.map((item, key) => (
            <li
