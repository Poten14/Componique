      ...
      >
        <div className="flex flex-col p-4">
          ...
          <div className="space-y-3 pt-3">
            <div
              className={`h-3 w-3/5 ${animationClass} ${variantsClasses[variants]} bg-gray`}
            ></div>
            <div
              className={`h-3 w-4/5 ${animationClass} ${variantsClasses[variants]} bg-gray`}
            ></div>
            <div
              className={`h-3 w-2/5 ${animationClass} ${variantsClasses[variants]} bg-gray`}
            ></div>
          </div>
        </div>
      </div>
