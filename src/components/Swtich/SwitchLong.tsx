  ...
  return (
    <div className="flex flex-col items-center space-y-6">
      <div
        ...
        className={`flex h-7 w-24 cursor-pointer items-center rounded-full p-1 ${isOn ? `bg-Basic` : `bg-[#9E9E9E]`}`}
      >
        <div
      ...
      <div
        onClick={toggleSwitch}
        className={`flex h-9 w-36 cursor-pointer items-center rounded-full p-1 ${isOn ? `bg-Basic` : `bg-[#9E9E9E]`}`}
      >
        <div
      ...
      <div
        onClick={toggleSwitch}
        className={`flex h-16 w-64 cursor-pointer items-center rounded-full p-2 ${isOn ? `bg-Basic` : `bg-[#9E9E9E]`}`}
      >
        <div
