    ...
    <>
      <div className="relative w-full">
        <div className="relative m-auto h-96 overflow-hidden rounded-lg">
          ...
          <button
            type="button"
            className="group absolute start-0 top-0 flex h-full cursor-pointer items-center justify-center px-4 focus:outline-none"
            onClick={handlePrev}
          >
          ...
          <button
            type="button"
            className="group absolute end-0 top-0 flex h-full cursor-pointer items-center justify-center px-4 focus:outline-none"
            onClick={handleNext}
          >
