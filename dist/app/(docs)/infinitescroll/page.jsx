...
export default FullExample;`} language="tsx" index={2} copied={copied} handleCopy={handleCopy}/>
      </div>
      <hr />
      {/* infinitescroll2 */}
      <div className="">
...
export default FullExample;`} language="tsx" index={2} copied={copied} handleCopy={handleCopy}/>
      ...
      <div className="">
        ...
        <p>
          데이터는{" "}
          <a href="https://koreanjson.com/posts/1" target="_blank" rel="noopener noreferrer">
            koreanjson.com
          </a>{" "}
