...
const InfiniteScrollBasic = ({ content }) => {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { className: "p-4", children: [(0, jsx_runtime_1.jsx)("ul", { className: "space-y-4", children: items.map((item) => ((0, jsx_runtime_1.jsx)("li", { className: "mb-2 border-b-2 border-dashed p-2 shadow-sm", children: item.text }, item.id))) }), (0, jsx_runtime_1.jsx)("div", { ref: loader, className: "py-10 text-center", children: isLoading && hasMore ? ((0, jsx_runtime_1.jsx)(BasicSpinner_1.default, {}) // 로딩 중일 때 스피너 표시
