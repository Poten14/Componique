...
const Header = () => {
    ...
    return ((0, jsx_runtime_1.jsxs)("header", { className: `fixed left-0 top-0 z-20 flex h-[90px] w-full items-center justify-between transition-colors duration-300 ${isScrolled ? "bg-white shadow-md dark:bg-[#252629]" : "bg-transparent"}`, children: [(0, jsx_runtime_1.jsxs)("div", { className: "flex items-center justify-between", children: [pathname.startsWith("/userpage") ? ((0, jsx_runtime_1.jsx)(Button_1.default, { className: "ml-4 mr-2 dark:bg-[#333742] xl:hidden", radius: "full", onClick: onclickDrawerHandler2(true), children: (0, jsx_runtime_1.jsx)(HamburgerMenu_1.default, {}) })) : (""), (0, jsx_runtime_1.jsx)(Logo_1.default, {})] }), (0, jsx_runtime_1.jsxs)("div", { className: "flex items-center", children: [(0, jsx_runtime_1.jsx)(SwitchDark_1.default, {}), (0, jsx_runtime_1.jsx)(UserPage_1.default, {}), pathname.startsWith("/userpage") ? ("") : ((0, jsx_runtime_1.jsx)(Button_1.default, { className: "mr-2 dark:bg-[#333742] xl:hidden", radius: "full", onClick: onclickDrawerHandler(true), children: (0, jsx_runtime_1.jsx)(HamburgerMenu_1.default, {}) })), (0, jsx_runtime_1.jsx)(Drawer_1.default, { className: "!text-[#9AC5E5] dark:bg-[#252629] dark:text-white", isOpen: isDrawer2Open, onClose: onclickDrawerHandler2(false), color: "white", bgColor: "white", logo: isDarkMode ? "/LogoDark.svg" : "/componique_logo_full.svg", menu: [
                            {
                                items: [
                        ...
                        ] }), (0, jsx_runtime_1.jsx)(Drawer_1.default, { isOpen: isDrawerOpen, className: "bg-white text-[#3e3e3e] dark:bg-[#252629] dark:text-white" // 다크 모드에서 텍스트 및 배경색 변경
                        , onClose: onclickDrawerHandler(false), color: "white", bgColor: "white" // 기본 모드에서는 white 사용
                        , logo: isDarkMode ? "/LogoDark.svg" : "/componique_logo_full.svg", position: "right", menu: [
                            {
