...
const Button = ({ size = "medium", color = "basic", radius = "medium", variant = "solid", className, icon, iconColor, disabled = false, iconSize = "medium", iconPosition = "left", children, ...rest }) => {
    ...
    return ((0, jsx_runtime_1.jsxs)("button", { className: `${basicButton} ${buttonSize} ${buttonRadius} ${ButtonVariant} ${className || ""}`, ...rest, children: [icon && iconPosition === "left" && ((0, jsx_runtime_1.jsx)(Icon_1.default, { name: icon, size: iconSizes, color: iconColor || "black" })), children, icon && iconPosition === "right" && ((0, jsx_runtime_1.jsx)(Icon_1.default, { name: icon, size: iconSizes, color: iconColor || "black" }))] }));
};
