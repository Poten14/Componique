...
const RemoteShopping = () => {
    ...
    const { title, subtitle, title2, currentPage, totalPages, paginationVariant, paginationStyleType, paginationColor, logoSrc, logoName, hoverColor, size, position, setShoppingState, } = useShoppingStore();
    const handleCopy = () => {
