...
const RadioButton = () => {
    ...
    return (<div className="prose max-w-[850px] p-5 text-[#6D6D6D] dark:text-[#dfdfdf]">
...
export default DescriptionExample;`} language="tsx" index={2} copied={copied} handleCopy={handleCopy}/>
        {/* 카피버튼 끝 */}
...
export default SizeExample;`} language="tsx" index={3} copied={copied} handleCopy={handleCopy}/>
        {/* 카피버튼 끝 */}
...
export default ColorExample;`} language="tsx" index={4} copied={copied} handleCopy={handleCopy}/>
        {/* 카피버튼 끝 */}
...
export default DisabledExample;`} language="tsx" index={5} copied={copied} handleCopy={handleCopy}/>
        {/* 카피버튼 끝 */}
