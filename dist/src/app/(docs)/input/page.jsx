...
export default Example;`} language="tsx" index={9} copied={copied} handleCopy={handleCopy}/>
...
export default Example;`} language="tsx" index={11} copied={copied} handleCopy={handleCopy}/>
...
export default Example;`} language="tsx" index={12} copied={copied} handleCopy={handleCopy}/>
...
export default Example;`} language="tsx" index={13} copied={copied} handleCopy={handleCopy}/>
      <hr />
...
export default Example;`} copyText={`import SearchInput3 from '@components/SearchInput2/SearchInput2';
      ...
      export default Example;`} language="tsx" index={15} copied={copied} handleCopy={handleCopy}/>
...
export default Example;`} language="tsx" index={16} copied={copied} handleCopy={handleCopy}/>
      <hr />
...
export default FullExample;`} language="tsx" index={19} copied={copied} handleCopy={handleCopy}/>
      <hr />
...
/>`} copyText={`<CurrencyInput
  ...
  value="$10.00"
  onValueChange={(value) => console.log("New value:", value)}
/>`} language="tsx" index={21} copied={copied} handleCopy={handleCopy}/>
...
export default FullExample;`} language="tsx" index={22} copied={copied} handleCopy={handleCopy}/>
      <hr />
...
/>`} copyText={`<DecimalInput
  ...
  value="10.00"
  onValueChange={(value) => console.log("New value:", value)}
/>`} language="tsx" index={24} copied={copied} handleCopy={handleCopy}/>
...
export default FullExample;`} language="tsx" index={25} copied={copied} handleCopy={handleCopy}/>
      <hr />
...
export default Example;`} language="tsx" index={27} copied={copied} handleCopy={handleCopy}/>
...
export default Example;`} language="tsx" index={28} copied={copied} handleCopy={handleCopy}/>
