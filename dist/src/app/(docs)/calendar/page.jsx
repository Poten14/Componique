...
const CalendarDocs = () => {
    ...
    return (<div className="prose max-w-[850px] p-5 text-[#6D6D6D]">
      ...
      <CodeBox code={`import Calendar from '@components/Calendar';`} copyText={`import Calendar from '@components/Calendar';`} language="tsx" index={1} copied={copied} handleCopy={handleCopy}/>
      ...
      <CodeBox code={`import Calendar from '@components/Calendar';
...
export default Example;`} language="tsx" index={2} copied={copied} handleCopy={handleCopy}/>
      ...
      <div className="my-7">
        <Calendar defaultValue={new Date()} onDateSelect={(date) => console.log(date)}/>
      </div>
...
export default Example;`} language="tsx" index={4} copied={copied} handleCopy={handleCopy}/>
      ...
      <CodeBox code={`import CalendarRange from '@components/CalendarRange';`} copyText={`import CalendarRange from '@components/CalendarRange';`} language="tsx" index={1} copied={copied} handleCopy={handleCopy}/>
      ...
      <CodeBox code={`import CalendarRange from '@components/CalendarRange';
...
export default Example;`} language="tsx" index={2} copied={copied} handleCopy={handleCopy}/>
      ...
      <div className="my-7">
        <CalendarRange onDateSelect={(startDate, endDate) => console.log("Selected range:", startDate, "to", endDate)}/>
      </div>
