...
export default FullExample;`} language="tsx" index={3} copied={copied} handleCopy={handleCopy}/>
        {/* 카피버튼 끝 */}
      </div>
      <hr />
      {/* Card2 */}
      <div>
        <h1 className="text-[#2D3748] dark:text-white">2. CardInteractive</h1>
        <p>
...
export default FullExample;`} language="tsx" index={6} copied={copied} handleCopy={handleCopy}/>
        {/* 카피버튼 끝 */}
      </div>
      ...
      <hr />
      <div>
        <h1 className="text-[#2D3748] dark:text-white">3. CardImage</h1>
        <p>
...
export default FullExample;`} language="tsx" index={9} copied={copied} handleCopy={handleCopy}/>
      ...
      <hr />
      <div>
        <h1 className="text-[#2D3748] dark:text-white">4. CardPricing</h1>
        <p>
...
export default FullExample;`} language="tsx" index={12} copied={copied} handleCopy={handleCopy}/>
        {/* 카피버튼 끝 */}
      </div>
      ...
      <hr />
      <div>
        <h1 className="text-[#2D3748] dark:text-white">5. CardReview</h1>
        <p>
